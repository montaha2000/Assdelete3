  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: TabBarView(
            children: [
              AllTasksScreen(changeTaskCompleteness , deleteFun),
              CompleteTasksScreen(changeTaskCompleteness , deleteFun),
              InCompleteTasksScreen(changeTaskCompleteness , deleteFun)
            ],
          ),
        ));
  }
